 ...
 *
 * Audit (bewusst implizit): Anders als {@see UserEmailVerifierContract} schreibt
 * dieser Service KEINEN expliziten Activity-Log-Eintrag. `approved_at` ist Teil
 * von {@see \App\Models\User::getActivitylogOptions()} (`logOnly`), weshalb der
 ...
 * (siehe {@see \App\Models\User::applyEventLabelToActivity()}). Im CLI-Pfad
 * hängt der `ConsoleActorContext` zusätzlich `cli_actor` an und nullt den Causer.
 *
