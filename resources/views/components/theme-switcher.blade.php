<div class="relative" x-data="themeSwitcher()" x-init="init()">
    ...
    <div x-show="open" @click.outside="open = false" x-transition
        ...
        <button @click="setTheme('system')"
                class="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-600 dark:focus-visible:outline-indigo-300 active:bg-gray-50 dark:active:bg-gray-700"
